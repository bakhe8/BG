...
public static class PermissionPolicyNames
{
    ...
    public const string OperationsManage = "permission.operations.manage";
    ...
    public const string ApprovalsSign = "permission.approvals.sign";
    ...
    public static void Configure(AuthorizationOptions options)
    {
        ...
        Add(options, OperationsQueue, "operations.queue.view");
        Add(options, OperationsManage, "operations.queue.manage");
        ...
        Add(options, ApprovalsQueue, "approvals.queue.view");
        Add(options, ApprovalsSign, "approvals.sign");
