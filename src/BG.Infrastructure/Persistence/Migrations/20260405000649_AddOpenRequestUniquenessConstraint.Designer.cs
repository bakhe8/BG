...
namespace BG.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260405000649_AddOpenRequestUniquenessConstraint")]
    partial class AddOpenRequestUniquenessConstraint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BG.Domain.Guarantees.Bank", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsEmailDispatchEnabled")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("SupportedDispatchChannels")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BG.Domain.Guarantees.GuaranteeRequest", b =>
                {
                    ...
                    b.HasIndex("RequestedByUserId", "GuaranteeId", "RequestType")
                        .IsUnique()
            ...
            modelBuilder.Entity("BG.Domain.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BG.Infrastructure.Identity.LoginAttemptRecord", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("WindowExpiresAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.HasKey("TrackingKey");
